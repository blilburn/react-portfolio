            ...
            <Container style={{ marginTop: 30 }}>
                <Row>
                    ...
                    <tr>
                        <td>Linked In</td>
                        <td>:</td>
                        {/* <td><a href="https://www.linkedin.com/in/bryan-lilburn-32ba181b8" target="_blank">Link to my profile</a></td> */}
                   </tr>
                    <tr>
                        <td>Github</td>
                        <td>:</td>
                        {/* <td><a href="https://github.com/blilburn" target="_blank">Link to my page</a></td> */}
                    </tr>
                </table>
